...
class ParameterReplacementPassTest extends \PHPUnit_Framework_TestCase
{
    public function testReplaceParameters()
    {
        ...
        $container->setParameter('incenteev_dynamic_parameters.parameters', array('foo' => array('yaml' => false)));
        ...
        $this->assertEquals('dynamic_parameter(\'foo\')', (string) $props['test']);
        ...
        $this->assertEquals('dynamic_parameter(\'foo\')', (string) $calls[0][1][0]);
        ...
        $this->assertEquals('dynamic_parameter(\'foo\')', (string) $calls[1][1][0]);
    }
    ...
    public function testReplaceYamlParameter()
    {
        ...
        $container->setParameter('foo', 'bar');
        $container->setParameter('incenteev_dynamic_parameters.parameters', array('foo' => array('yaml' => true)));
        ...
        $this->assertInstanceOf('Symfony\Component\ExpressionLanguage\Expression', $props['test'], 'Parameters are replaced in properties');
        $this->assertEquals('dynamic_yaml_parameter(\'foo\')', (string) $props['test']);
    }
}
